	...
	<div class="card shadow mb-4">
	    ...
	    <div class="row">
	        <div class="col-xl-12">
	            ...
	            <table id="pembayaran_hutang_table_det" data-toggle="table" data-select-item-name="toolbar1" data-sort-name="id_jurnal" data-url="<?php echo base_url('Member/HistoryController/get_tampil_pinjaman');?>" data-sort-order="desc">
	                <thead>
	                    <tr>
