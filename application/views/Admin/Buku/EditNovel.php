                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Novel</h6>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="isbn" value="<?= $b->isbn ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Judul Novel</label>
                                        <!-- <input type="hidden" name="id_buku" value="<?= $b->id_buku ?>"> -->
                                        <input type="text" class="form-control" name="judul_buku" value="<?= $b->judul_buku ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Penulis</label>
                                        <input type="text" class="form-control" name="penulis_buku" value="<?= $b->penulis_buku ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Penerbit</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Sampul Novel</label>
