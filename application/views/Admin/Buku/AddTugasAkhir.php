                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Buku Tugas Akhir</h6>
                            ...
                            <div class="table-responsive">
                                ...
                                <form action=<?php echo base_url() . 'BukuController/add_buku'; ?> enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="inputCity">Judul Tugas Akhir</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="inputCity">Penulis Tugas Akhir</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="nim_penulis" required>

                                    </div>

                                    <!-- <div class="form-group col-md-6">

                                        <label for="inputCity">Penerbit Tugas Akhir</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" name="jenis_buku" value="Tugas Akhir">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" name="stok_buku" value="1">
