                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Laporan PKL</h6>
                            ...
                            <div class="table-responsive">
                                ...
                                <form action=<?php echo base_url() . 'BukuController/add_buku'; ?> enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="inputCity">Judul Laporan PKL</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" name="jenis_buku" value="Laporan PKL">
