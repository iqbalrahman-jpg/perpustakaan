                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Tugas Akhir</h6>
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="<?= base_url('BukuController/edit_buku') ?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="nim_penulis" value="<?= $b->nim_penulis ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Sampul Tugas Akhir</label>
